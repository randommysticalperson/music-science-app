...
import { Music, Activity, Waves, Home, Menu, X, Github, ListMusic, Languages, BookOpen, Piano, Keyboard } from "lucide-react";
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { path: "/continuous-piano", label: t("continuousPianoNav"), icon: Keyboard, accent: "#00d4ff" },
  ];
